...
def generate_barcode(value):
    """API URL se barcode image generate karta hai"""
    if not value:
        return ""

    base_url = frappe.utils.get_url()
    img_url = f"{base_url}/api/method/custom_api.utils.barcode_utils.get_barcode_image?value={value}"

    return f'<img src="{img_url}" style="width:100%; max-width:350px; height:80px;">'