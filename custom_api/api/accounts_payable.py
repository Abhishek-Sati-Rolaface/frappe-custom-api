...
def _calculate_payable_kpis(rows):
    ...
    concentration_ratio = (
        sum(v for _, v in top_suppliers) / total_outstanding if total_outstanding else 0
    )
    ...
    return {
        ...
        # "supplier_concentration_ratio": round(concentration_ratio, 2),
